...
const ServiceUsageReport = ({ reportData }) => {
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                {/* Header */}
                <View style={styles.header}>
                    <Text style={styles.headerText}>MagisNails | Reporte de Servicios</Text>
                </View>
                ...
                {reportData.length > 0 ? (
                    <View style={styles.table}>
                        ...
                        <View style={styles.tableRow}>
                            <Text style={styles.tableColHeader}>Nombre del Servicio</Text>
                            <Text style={styles.tableColHeader}>Total de Citas</Text>
                            <Text style={styles.tableColHeader}>Total de Ganancia</Text>
                        </View>
